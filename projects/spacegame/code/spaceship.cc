...
SpaceShip::Update(float dt)
{
    ...
    Render::Camera* cam = CameraManager::GetCamera(CAMERA_MAIN);
    ...
    quat localOrientation = quat(glm::vec3(-rotYSmooth, rotXSmooth, rotZSmooth));
    ...
    this->transform = T * (glm::mat4)quat(glm::vec3(0, 0, rotationZ));
